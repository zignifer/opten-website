...
- **Текст читаемый, но не главный:** белый или лаймовый, высокий контраст,
  крупный кегль, простор вокруг букв. Внутристатейные кадры с текстом генерируй
  сразу как финальные RU/EN изображения. Не делай базовый кадр без текста с
  последующим локальным наложением подписи; если текст сломан — перегенерируй
  кадр с более короткой надписью.
...
- Минимализм, тёмная тема, мягкое лаймовое свечение. Акцентный лайм всегда
  ровно `#9CFB51`; не заменять его желтовато-зелёным, тёмно-зелёным,
  acid/neon green без hex или любым «примерно лаймовым» оттенком.
