...
if (sitemapRoutes.length < 164) {
  throw new Error(`sitemap.mjs: expected at least 164 routes (38 baseline/blog routes + 2 model hubs + 124 model pages after daily blog posts), got ${sitemapRoutes.length}. Manifest mis-loaded or entries missing?`);
}
