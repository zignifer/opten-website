...
if (prerenderedRoutes.length < 216) {
  throw new Error(
    `llms.mjs: expected at least 216 prerendered routes (66 marketing/blog routes + 24 Learn routes + 126 model routes), got ${prerenderedRoutes.length}. Manifest mis-loaded or routes missing?`,
  );
}
