...
if (prerenderedRoutes.length < 164) {
  throw new Error(
    `llms.mjs: expected at least 164 prerendered routes (38 baseline/blog routes + 2 model hubs + 124 model pages after daily blog posts), got ${prerenderedRoutes.length}. Manifest mis-loaded or routes missing?`,
  );
}
