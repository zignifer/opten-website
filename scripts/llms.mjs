...
if (prerenderedRoutes.length < 200) {
  throw new Error(
    `llms.mjs: expected at least 200 prerendered routes (54 baseline/blog routes + 20 Learn routes + 2 model hubs + 124 model pages), got ${prerenderedRoutes.length}. Manifest mis-loaded or routes missing?`,
  );
}
