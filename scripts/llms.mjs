...
// content files landed. Blog posts now bring the floor to 156. SPA-only routes
// carry prerender:"none" and are excluded.
if (prerenderedRoutes.length < 156) {
  throw new Error(
    `llms.mjs: expected at least 156 prerendered routes (30 baseline/blog routes + 2 model hubs + 124 model pages after the sora-2-vs-veo-3-1 blog post), got ${prerenderedRoutes.length}. Manifest mis-loaded or routes missing?`,
  );
}
