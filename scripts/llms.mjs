...
if (prerenderedRoutes.length < 188) {
  throw new Error(
    `llms.mjs: expected at least 188 prerendered routes (48 baseline/blog routes + 14 Learn routes + 2 model hubs + 124 model pages), got ${prerenderedRoutes.length}. Manifest mis-loaded or routes missing?`,
  );
}
