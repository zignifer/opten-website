...
if (prerenderedRoutes.length < 198) {
  throw new Error(
    `llms.mjs: expected at least 198 prerendered routes (52 baseline/blog routes + 20 Learn routes + 2 model hubs + 124 model pages), got ${prerenderedRoutes.length}. Manifest mis-loaded or routes missing?`,
  );
}
