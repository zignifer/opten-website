...
// content files landed. Blog posts bring the floor to 168; public Learn adds 14 more. SPA-only routes
// carry prerender:"none" and are excluded.
if (prerenderedRoutes.length < 182) {
  throw new Error(
    `llms.mjs: expected at least 182 prerendered routes (42 baseline/blog routes + 14 Learn routes + 2 model hubs + 124 model pages), got ${prerenderedRoutes.length}. Manifest mis-loaded or routes missing?`,
  );
}
