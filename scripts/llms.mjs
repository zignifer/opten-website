...
if (prerenderedRoutes.length < 204) {
  throw new Error(
    `llms.mjs: expected at least 204 prerendered routes (54 marketing/blog routes + 24 Learn routes + 126 model routes), got ${prerenderedRoutes.length}. Manifest mis-loaded or routes missing?`,
  );
}
