...
if (prerenderedRoutes.length < 210) {
  throw new Error(
    `llms.mjs: expected at least 210 prerendered routes (60 marketing/blog routes + 24 Learn routes + 126 model routes), got ${prerenderedRoutes.length}. Manifest mis-loaded or routes missing?`,
  );
}
