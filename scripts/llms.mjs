...
// content files landed. Blog posts now bring the floor to 162. SPA-only routes
// carry prerender:"none" and are excluded.
if (prerenderedRoutes.length < 162) {
  throw new Error(
    `llms.mjs: expected at least 162 prerendered routes (36 baseline/blog routes + 2 model hubs + 124 model pages after daily blog posts), got ${prerenderedRoutes.length}. Manifest mis-loaded or routes missing?`,
  );
}
