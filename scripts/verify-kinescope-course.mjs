...
assert.match(content, /PRIVATE_COURSE_PRICE_USD\s*=\s*41/, "Private course base price must be 41 USD");
assert.match(content, /PRIVATE_COURSE_LIST_PRICE_USD\s*=\s*41/, "Private course list price must stay 41 USD");
