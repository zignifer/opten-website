...
import { post as midjourneyAlternatives2026Guide } from "../src/content/blog/midjourney-alternatives-2026";
import { post as bestAiImageGenerator2026Guide } from "../src/content/blog/best-ai-image-generator-2026";
...
export const routes: RouteMeta[] = [
  ...
  },
  {
    ...
    description: "Opten установлен. Закрепи расширение, войди по Email-коду и начни оценивать промпты прямо в интерфейсе AI-генератора.",
  ...
  // added in B-05. Listing page only emits CollectionPage + ItemList + WebPage + BreadcrumbList.
  {
    ...
    title: "Блог Opten — нейросети, промпты и вайб-кодинг",
    description: "Практические гайды по нейросетям, промптам, вайб-кодингу, AI-контенту и заработку с ИИ. Рабочие процессы и инструменты без воды.",
    canonical: `${SITE_ORIGIN}/blog`,
    ogTitle: "Блог Opten",
    ogDescription: "Гайды по нейросетям, промптам, вайб-кодингу, AI-контенту и заработку с ИИ.",
    author: FOUNDER_NAME,
    prerender: "full",
    changefreq: "weekly",
    priority: 0.8,
    schema: [
      ...
      collectionPageBlock({
        ...
        name: "Блог Opten",
        description: "Гайды по нейросетям, промптам, вайб-кодингу, AI-контенту и заработку с ИИ.",
        inLanguage: "ru-RU",
      }),
      itemListBlock(
        [
          // Phase 5 B-07: /guides retired; ItemList points at the new /blog canonical (codex review P2).
          { url: `${SITE_ORIGIN}/blog/midjourney-alternatives-2026`, name: midjourneyAlternatives2026Guide.ru.title, datePublished: midjourneyAlternatives2026Guide.ru.publishedAt },
          { url: `${SITE_ORIGIN}/blog/best-ai-image-generator-2026`, name: bestAiImageGenerator2026Guide.ru.title, datePublished: bestAiImageGenerator2026Guide.ru.publishedAt },
  ...
  // seo2 manual blog automation: /blog/midjourney-alternatives-2026.
  {
    path: "/blog/midjourney-alternatives-2026",
    htmlLang: "ru",
    hreflangAlternates: { ru: `${SITE_ORIGIN}/blog/midjourney-alternatives-2026`, en: `${SITE_ORIGIN}/en/blog/midjourney-alternatives-2026`, xDefault: `${SITE_ORIGIN}/blog/midjourney-alternatives-2026` },
    title: midjourneyAlternatives2026Guide.ru.title,
    description: midjourneyAlternatives2026Guide.ru.description,
    canonical: `${SITE_ORIGIN}/blog/midjourney-alternatives-2026`,
    ogTitle: midjourneyAlternatives2026Guide.ru.title,
    ogDescription: midjourneyAlternatives2026Guide.ru.excerpt,
    ogImage: `${SITE_ORIGIN}${midjourneyAlternatives2026Guide.ru.cover.src}`,
    author: FOUNDER_NAME, prerender: "full", changefreq: "monthly", priority: 0.7,
    schema: [
      ORG_BLOCK,
      blogPostingBlock({ pageId: `${SITE_ORIGIN}/blog/midjourney-alternatives-2026`, headline: midjourneyAlternatives2026Guide.ru.title, description: midjourneyAlternatives2026Guide.ru.description, datePublished: midjourneyAlternatives2026Guide.ru.publishedAt, dateModified: midjourneyAlternatives2026Guide.ru.updatedAt, inLanguage: "ru-RU", articleSection: "Гайд", keywords: midjourneyAlternatives2026Guide.ru.tags, image: { url: `${SITE_ORIGIN}${midjourneyAlternatives2026Guide.ru.cover.src}`, width: midjourneyAlternatives2026Guide.ru.cover.width, height: midjourneyAlternatives2026Guide.ru.cover.height } }),
      webPageBlock({ pageId: `${SITE_ORIGIN}/blog/midjourney-alternatives-2026`, url: `${SITE_ORIGIN}/blog/midjourney-alternatives-2026`, name: midjourneyAlternatives2026Guide.ru.title, inLanguage: "ru-RU", cssSelector: ["h1", ".blog-intro", "h2"] }),
      howToBlock((midjourneyAlternatives2026Guide.ru.body.steps ?? []).map((s) => ({ title: s.title, body: s.body })), `${SITE_ORIGIN}/blog/midjourney-alternatives-2026`, midjourneyAlternatives2026Guide.ru.title),
      faqPageBlock(midjourneyAlternatives2026Guide.ru.body.faq ?? [], `${SITE_ORIGIN}/blog/midjourney-alternatives-2026`),
      breadcrumbBlock([{ name: "Главная", url: `${SITE_ORIGIN}/` }, { name: "Блог", url: `${SITE_ORIGIN}/blog` }, { name: midjourneyAlternatives2026Guide.ru.title, url: `${SITE_ORIGIN}/blog/midjourney-alternatives-2026` }], `${SITE_ORIGIN}/blog/midjourney-alternatives-2026`),
    ],
  },

  // seo2 manual blog automation: /blog/best-ai-image-generator-2026.
  {
    path: "/blog/best-ai-image-generator-2026",
    htmlLang: "ru",
    hreflangAlternates: { ru: `${SITE_ORIGIN}/blog/best-ai-image-generator-2026`, en: `${SITE_ORIGIN}/en/blog/best-ai-image-generator-2026`, xDefault: `${SITE_ORIGIN}/blog/best-ai-image-generator-2026` },
    title: bestAiImageGenerator2026Guide.ru.title,
    description: bestAiImageGenerator2026Guide.ru.description,
    canonical: `${SITE_ORIGIN}/blog/best-ai-image-generator-2026`,
    ogTitle: bestAiImageGenerator2026Guide.ru.title,
    ogDescription: bestAiImageGenerator2026Guide.ru.excerpt,
    ogImage: `${SITE_ORIGIN}${bestAiImageGenerator2026Guide.ru.cover.src}`,
    author: FOUNDER_NAME, prerender: "full", changefreq: "monthly", priority: 0.7,
    schema: [
      ORG_BLOCK,
      blogPostingBlock({ pageId: `${SITE_ORIGIN}/blog/best-ai-image-generator-2026`, headline: bestAiImageGenerator2026Guide.ru.title, description: bestAiImageGenerator2026Guide.ru.description, datePublished: bestAiImageGenerator2026Guide.ru.publishedAt, dateModified: bestAiImageGenerator2026Guide.ru.updatedAt, inLanguage: "ru-RU", articleSection: "Гайд", keywords: bestAiImageGenerator2026Guide.ru.tags, image: { url: `${SITE_ORIGIN}${bestAiImageGenerator2026Guide.ru.cover.src}`, width: bestAiImageGenerator2026Guide.ru.cover.width, height: bestAiImageGenerator2026Guide.ru.cover.height } }),
      webPageBlock({ pageId: `${SITE_ORIGIN}/blog/best-ai-image-generator-2026`, url: `${SITE_ORIGIN}/blog/best-ai-image-generator-2026`, name: bestAiImageGenerator2026Guide.ru.title, inLanguage: "ru-RU", cssSelector: ["h1", ".blog-intro", "h2"] }),
      howToBlock((bestAiImageGenerator2026Guide.ru.body.steps ?? []).map((s) => ({ title: s.title, body: s.body })), `${SITE_ORIGIN}/blog/best-ai-image-generator-2026`, bestAiImageGenerator2026Guide.ru.title),
      faqPageBlock(bestAiImageGenerator2026Guide.ru.body.faq ?? [], `${SITE_ORIGIN}/blog/best-ai-image-generator-2026`),
      breadcrumbBlock([{ name: "Главная", url: `${SITE_ORIGIN}/` }, { name: "Блог", url: `${SITE_ORIGIN}/blog` }, { name: bestAiImageGenerator2026Guide.ru.title, url: `${SITE_ORIGIN}/blog/best-ai-image-generator-2026` }], `${SITE_ORIGIN}/blog/best-ai-image-generator-2026`),
    ],
  },
  ...
  // seo2 manual blog automation: /blog/web-design-with-ai.
  {
    path: "/blog/web-design-with-ai",
    htmlLang: "ru",
    hreflangAlternates: { ru: `${SITE_ORIGIN}/blog/web-design-with-ai`, en: `${SITE_ORIGIN}/en/blog/web-design-with-ai`, xDefault: `${SITE_ORIGIN}/blog/web-design-with-ai` },
    title: webDesignWithAiGuide.ru.title,
    description: webDesignWithAiGuide.ru.description,
    canonical: `${SITE_ORIGIN}/blog/web-design-with-ai`,
    ogTitle: webDesignWithAiGuide.ru.title,
    ogDescription: webDesignWithAiGuide.ru.excerpt,
    ogImage: `${SITE_ORIGIN}${webDesignWithAiGuide.ru.cover.src}`,
    author: FOUNDER_NAME, prerender: "full", changefreq: "monthly", priority: 0.7,
    schema: [
      ORG_BLOCK,
      blogPostingBlock({ pageId: `${SITE_ORIGIN}/blog/web-design-with-ai`, headline: webDesignWithAiGuide.ru.title, description: webDesignWithAiGuide.ru.description, datePublished: webDesignWithAiGuide.ru.publishedAt, dateModified: webDesignWithAiGuide.ru.updatedAt, inLanguage: "ru-RU", articleSection: "Гайд", keywords: webDesignWithAiGuide.ru.tags, image: { url: `${SITE_ORIGIN}${webDesignWithAiGuide.ru.cover.src}`, width: webDesignWithAiGuide.ru.cover.width, height: webDesignWithAiGuide.ru.cover.height } }),
      webPageBlock({ pageId: `${SITE_ORIGIN}/blog/web-design-with-ai`, url: `${SITE_ORIGIN}/blog/web-design-with-ai`, name: webDesignWithAiGuide.ru.title, inLanguage: "ru-RU", cssSelector: ["h1", ".blog-intro", "h2"] }),
      howToBlock((webDesignWithAiGuide.ru.body.steps ?? []).map((s) => ({ title: s.title, body: s.body })), `${SITE_ORIGIN}/blog/web-design-with-ai`, webDesignWithAiGuide.ru.title),
      faqPageBlock(webDesignWithAiGuide.ru.body.faq ?? [], `${SITE_ORIGIN}/blog/web-design-with-ai`),
      breadcrumbBlock([{ name: "Главная", url: `${SITE_ORIGIN}/` }, { name: "Блог", url: `${SITE_ORIGIN}/blog` }, { name: webDesignWithAiGuide.ru.title, url: `${SITE_ORIGIN}/blog/web-design-with-ai` }], `${SITE_ORIGIN}/blog/web-design-with-ai`),
    ],
  },
  ...
  // seo2 manual blog automation: /blog/ai-for-work — practical AI work guide.
  {
    path: "/blog/ai-for-work",
    htmlLang: "ru",
    hreflangAlternates: {
      ru: `${SITE_ORIGIN}/blog/ai-for-work`,
      en: `${SITE_ORIGIN}/en/blog/ai-for-work`,
      xDefault: `${SITE_ORIGIN}/blog/ai-for-work`,
    },
    title: aiForWorkGuide.ru.title,
    description: aiForWorkGuide.ru.description,
    canonical: `${SITE_ORIGIN}/blog/ai-for-work`,
    ogTitle: aiForWorkGuide.ru.title,
    ogDescription: aiForWorkGuide.ru.excerpt,
    ogImage: `${SITE_ORIGIN}${aiForWorkGuide.ru.cover.src}`,
    author: FOUNDER_NAME,
    prerender: "full",
    changefreq: "monthly",
    priority: 0.7,
    schema: [
      ORG_BLOCK,
      blogPostingBlock({
        pageId: `${SITE_ORIGIN}/blog/ai-for-work`,
        headline: aiForWorkGuide.ru.title,
        description: aiForWorkGuide.ru.description,
        datePublished: aiForWorkGuide.ru.publishedAt,
        dateModified: aiForWorkGuide.ru.updatedAt,
        inLanguage: "ru-RU",
        articleSection: "Гайд",
        keywords: aiForWorkGuide.ru.tags,
        image: {
          url: `${SITE_ORIGIN}${aiForWorkGuide.ru.cover.src}`,
          width: aiForWorkGuide.ru.cover.width,
          height: aiForWorkGuide.ru.cover.height,
        },
      }),
      webPageBlock({
        pageId: `${SITE_ORIGIN}/blog/ai-for-work`,
        url: `${SITE_ORIGIN}/blog/ai-for-work`,
        name: aiForWorkGuide.ru.title,
        inLanguage: "ru-RU",
        cssSelector: ["h1", ".blog-intro", "h2"],
      }),
      howToBlock(
        (aiForWorkGuide.ru.body.steps ?? []).map((s) => ({ title: s.title, body: s.body })),
        `${SITE_ORIGIN}/blog/ai-for-work`,
        aiForWorkGuide.ru.title,
      ),
      faqPageBlock(aiForWorkGuide.ru.body.faq ?? [], `${SITE_ORIGIN}/blog/ai-for-work`),
      breadcrumbBlock(
        [
          { name: "Главная", url: `${SITE_ORIGIN}/` },
          { name: "Блог", url: `${SITE_ORIGIN}/blog` },
          { name: aiForWorkGuide.ru.title, url: `${SITE_ORIGIN}/blog/ai-for-work` },
        ],
        `${SITE_ORIGIN}/blog/ai-for-work`,
      ),
    ],
  ...
  // seo2 manual blog automation: /blog/ai-courses-for-beginners — AI course selection guide.
  {
    path: "/blog/ai-courses-for-beginners",
    htmlLang: "ru",
    hreflangAlternates: {
      ru: `${SITE_ORIGIN}/blog/ai-courses-for-beginners`,
      en: `${SITE_ORIGIN}/en/blog/ai-courses-for-beginners`,
      xDefault: `${SITE_ORIGIN}/blog/ai-courses-for-beginners`,
    },
    title: aiCoursesForBeginnersGuide.ru.title,
    description: aiCoursesForBeginnersGuide.ru.description,
    canonical: `${SITE_ORIGIN}/blog/ai-courses-for-beginners`,
    ogTitle: aiCoursesForBeginnersGuide.ru.title,
    ogDescription: aiCoursesForBeginnersGuide.ru.excerpt,
    ogImage: `${SITE_ORIGIN}${aiCoursesForBeginnersGuide.ru.cover.src}`,
    author: FOUNDER_NAME,
    prerender: "full",
    changefreq: "monthly",
    priority: 0.7,
    schema: [
      ORG_BLOCK,
      blogPostingBlock({
        pageId: `${SITE_ORIGIN}/blog/ai-courses-for-beginners`,
        headline: aiCoursesForBeginnersGuide.ru.title,
        description: aiCoursesForBeginnersGuide.ru.description,
        datePublished: aiCoursesForBeginnersGuide.ru.publishedAt,
        dateModified: aiCoursesForBeginnersGuide.ru.updatedAt,
        inLanguage: "ru-RU",
        articleSection: "Гайд",
        keywords: aiCoursesForBeginnersGuide.ru.tags,
        image: {
          url: `${SITE_ORIGIN}${aiCoursesForBeginnersGuide.ru.cover.src}`,
          width: aiCoursesForBeginnersGuide.ru.cover.width,
          height: aiCoursesForBeginnersGuide.ru.cover.height,
        },
      }),
      webPageBlock({
        pageId: `${SITE_ORIGIN}/blog/ai-courses-for-beginners`,
        url: `${SITE_ORIGIN}/blog/ai-courses-for-beginners`,
        name: aiCoursesForBeginnersGuide.ru.title,
        inLanguage: "ru-RU",
        cssSelector: ["h1", ".blog-intro", "h2"],
      }),
      howToBlock(
        (aiCoursesForBeginnersGuide.ru.body.steps ?? []).map((s) => ({ title: s.title, body: s.body })),
        `${SITE_ORIGIN}/blog/ai-courses-for-beginners`,
        aiCoursesForBeginnersGuide.ru.title,
      ),
      faqPageBlock(aiCoursesForBeginnersGuide.ru.body.faq ?? [], `${SITE_ORIGIN}/blog/ai-courses-for-beginners`),
      breadcrumbBlock(
        [
          { name: "Главная", url: `${SITE_ORIGIN}/` },
          { name: "Блог", url: `${SITE_ORIGIN}/blog` },
          { name: aiCoursesForBeginnersGuide.ru.title, url: `${SITE_ORIGIN}/blog/ai-courses-for-beginners` },
        ],
        `${SITE_ORIGIN}/blog/ai-courses-for-beginners`,
      ),
    ],
  ...
  },
  {
    ...
    description: "Opten is installed. Pin the extension, sign in with an Email code, and start scoring prompts right inside the AI generator interface.",
  ...
  // Phase 5 B-04: /en/blog hub. Mirror of /blog with EN copy and en-US schema language.
  {
    ...
    title: "Opten Blog — AI, prompts, and vibe coding guides",
    description: "Practical guides to AI, prompts, vibe coding, content creation, and earning with AI. Useful workflows and tools, explained without the fluff.",
    canonical: `${SITE_ORIGIN}/en/blog`,
    ogTitle: "Opten Blog",
    ogDescription: "Guides to AI, prompts, vibe coding, content creation, and earning with AI.",
    ogImage: DEFAULT_OG_IMAGE_EN,
    author: FOUNDER_NAME,
    prerender: "full",
    changefreq: "weekly",
    ...
    schema: [
      ...
      collectionPageBlock({
        ...
        name: "Opten Blog",
        description: "Guides to AI, prompts, vibe coding, content creation, and earning with AI.",
        inLanguage: "en-US",
      }),
      itemListBlock(
        [
          // Phase 5 B-07: /en/guides retired; ItemList points at the new /en/blog canonical (codex review P2).
          { url: `${SITE_ORIGIN}/en/blog/midjourney-alternatives-2026`, name: midjourneyAlternatives2026Guide.en.title, datePublished: midjourneyAlternatives2026Guide.en.publishedAt },
          { url: `${SITE_ORIGIN}/en/blog/best-ai-image-generator-2026`, name: bestAiImageGenerator2026Guide.en.title, datePublished: bestAiImageGenerator2026Guide.en.publishedAt },
  ...
  // seo2 manual blog automation: /en/blog/midjourney-alternatives-2026 EN sibling.
  {
    path: "/en/blog/midjourney-alternatives-2026",
    htmlLang: "en",
    hreflangAlternates: { ru: `${SITE_ORIGIN}/blog/midjourney-alternatives-2026`, en: `${SITE_ORIGIN}/en/blog/midjourney-alternatives-2026`, xDefault: `${SITE_ORIGIN}/blog/midjourney-alternatives-2026` },
    title: midjourneyAlternatives2026Guide.en.title,
    description: midjourneyAlternatives2026Guide.en.description,
    canonical: `${SITE_ORIGIN}/en/blog/midjourney-alternatives-2026`,
    ogTitle: midjourneyAlternatives2026Guide.en.title,
    ogDescription: midjourneyAlternatives2026Guide.en.excerpt,
    ogImage: `${SITE_ORIGIN}${midjourneyAlternatives2026Guide.en.cover.src}`,
    author: FOUNDER_NAME, prerender: "full", changefreq: "monthly", priority: 0.7,
    schema: [
      ORG_BLOCK_EN,
      blogPostingBlock({ pageId: `${SITE_ORIGIN}/en/blog/midjourney-alternatives-2026`, headline: midjourneyAlternatives2026Guide.en.title, description: midjourneyAlternatives2026Guide.en.description, datePublished: midjourneyAlternatives2026Guide.en.publishedAt, dateModified: midjourneyAlternatives2026Guide.en.updatedAt, inLanguage: "en-US", articleSection: "Guide", keywords: midjourneyAlternatives2026Guide.en.tags, image: { url: `${SITE_ORIGIN}${midjourneyAlternatives2026Guide.en.cover.src}`, width: midjourneyAlternatives2026Guide.en.cover.width, height: midjourneyAlternatives2026Guide.en.cover.height } }),
      webPageBlock({ pageId: `${SITE_ORIGIN}/en/blog/midjourney-alternatives-2026`, url: `${SITE_ORIGIN}/en/blog/midjourney-alternatives-2026`, name: midjourneyAlternatives2026Guide.en.title, inLanguage: "en-US", cssSelector: ["h1", ".blog-intro", "h2"] }),
      howToBlock((midjourneyAlternatives2026Guide.en.body.steps ?? []).map((s) => ({ title: s.title, body: s.body })), `${SITE_ORIGIN}/en/blog/midjourney-alternatives-2026`, midjourneyAlternatives2026Guide.en.title),
      faqPageBlock(midjourneyAlternatives2026Guide.en.body.faq ?? [], `${SITE_ORIGIN}/en/blog/midjourney-alternatives-2026`),
      breadcrumbBlock([{ name: "Home", url: `${SITE_ORIGIN}/en/` }, { name: "Blog", url: `${SITE_ORIGIN}/en/blog` }, { name: midjourneyAlternatives2026Guide.en.title, url: `${SITE_ORIGIN}/en/blog/midjourney-alternatives-2026` }], `${SITE_ORIGIN}/en/blog/midjourney-alternatives-2026`),
    ],
  },

  // seo2 manual blog automation: /en/blog/best-ai-image-generator-2026 EN sibling.
  {
    path: "/en/blog/best-ai-image-generator-2026",
    htmlLang: "en",
    hreflangAlternates: { ru: `${SITE_ORIGIN}/blog/best-ai-image-generator-2026`, en: `${SITE_ORIGIN}/en/blog/best-ai-image-generator-2026`, xDefault: `${SITE_ORIGIN}/blog/best-ai-image-generator-2026` },
    title: bestAiImageGenerator2026Guide.en.title,
    description: bestAiImageGenerator2026Guide.en.description,
    canonical: `${SITE_ORIGIN}/en/blog/best-ai-image-generator-2026`,
    ogTitle: bestAiImageGenerator2026Guide.en.title,
    ogDescription: bestAiImageGenerator2026Guide.en.excerpt,
    ogImage: `${SITE_ORIGIN}${bestAiImageGenerator2026Guide.en.cover.src}`,
    author: FOUNDER_NAME, prerender: "full", changefreq: "monthly", priority: 0.7,
    schema: [
      ORG_BLOCK_EN,
      blogPostingBlock({ pageId: `${SITE_ORIGIN}/en/blog/best-ai-image-generator-2026`, headline: bestAiImageGenerator2026Guide.en.title, description: bestAiImageGenerator2026Guide.en.description, datePublished: bestAiImageGenerator2026Guide.en.publishedAt, dateModified: bestAiImageGenerator2026Guide.en.updatedAt, inLanguage: "en-US", articleSection: "Guide", keywords: bestAiImageGenerator2026Guide.en.tags, image: { url: `${SITE_ORIGIN}${bestAiImageGenerator2026Guide.en.cover.src}`, width: bestAiImageGenerator2026Guide.en.cover.width, height: bestAiImageGenerator2026Guide.en.cover.height } }),
      webPageBlock({ pageId: `${SITE_ORIGIN}/en/blog/best-ai-image-generator-2026`, url: `${SITE_ORIGIN}/en/blog/best-ai-image-generator-2026`, name: bestAiImageGenerator2026Guide.en.title, inLanguage: "en-US", cssSelector: ["h1", ".blog-intro", "h2"] }),
      howToBlock((bestAiImageGenerator2026Guide.en.body.steps ?? []).map((s) => ({ title: s.title, body: s.body })), `${SITE_ORIGIN}/en/blog/best-ai-image-generator-2026`, bestAiImageGenerator2026Guide.en.title),
      faqPageBlock(bestAiImageGenerator2026Guide.en.body.faq ?? [], `${SITE_ORIGIN}/en/blog/best-ai-image-generator-2026`),
      breadcrumbBlock([{ name: "Home", url: `${SITE_ORIGIN}/en/` }, { name: "Blog", url: `${SITE_ORIGIN}/en/blog` }, { name: bestAiImageGenerator2026Guide.en.title, url: `${SITE_ORIGIN}/en/blog/best-ai-image-generator-2026` }], `${SITE_ORIGIN}/en/blog/best-ai-image-generator-2026`),
    ],
  },
  ...
  // seo2 manual blog automation: /en/blog/web-design-with-ai EN sibling.
  {
    path: "/en/blog/web-design-with-ai",
    htmlLang: "en",
    hreflangAlternates: { ru: `${SITE_ORIGIN}/blog/web-design-with-ai`, en: `${SITE_ORIGIN}/en/blog/web-design-with-ai`, xDefault: `${SITE_ORIGIN}/blog/web-design-with-ai` },
    title: webDesignWithAiGuide.en.title,
    description: webDesignWithAiGuide.en.description,
    canonical: `${SITE_ORIGIN}/en/blog/web-design-with-ai`,
    ogTitle: webDesignWithAiGuide.en.title,
    ogDescription: webDesignWithAiGuide.en.excerpt,
    ogImage: `${SITE_ORIGIN}${webDesignWithAiGuide.en.cover.src}`,
    author: FOUNDER_NAME, prerender: "full", changefreq: "monthly", priority: 0.7,
    schema: [
      ORG_BLOCK_EN,
      blogPostingBlock({ pageId: `${SITE_ORIGIN}/en/blog/web-design-with-ai`, headline: webDesignWithAiGuide.en.title, description: webDesignWithAiGuide.en.description, datePublished: webDesignWithAiGuide.en.publishedAt, dateModified: webDesignWithAiGuide.en.updatedAt, inLanguage: "en-US", articleSection: "Guide", keywords: webDesignWithAiGuide.en.tags, image: { url: `${SITE_ORIGIN}${webDesignWithAiGuide.en.cover.src}`, width: webDesignWithAiGuide.en.cover.width, height: webDesignWithAiGuide.en.cover.height } }),
      webPageBlock({ pageId: `${SITE_ORIGIN}/en/blog/web-design-with-ai`, url: `${SITE_ORIGIN}/en/blog/web-design-with-ai`, name: webDesignWithAiGuide.en.title, inLanguage: "en-US", cssSelector: ["h1", ".blog-intro", "h2"] }),
      howToBlock((webDesignWithAiGuide.en.body.steps ?? []).map((s) => ({ title: s.title, body: s.body })), `${SITE_ORIGIN}/en/blog/web-design-with-ai`, webDesignWithAiGuide.en.title),
      faqPageBlock(webDesignWithAiGuide.en.body.faq ?? [], `${SITE_ORIGIN}/en/blog/web-design-with-ai`),
      breadcrumbBlock([{ name: "Home", url: `${SITE_ORIGIN}/en/` }, { name: "Blog", url: `${SITE_ORIGIN}/en/blog` }, { name: webDesignWithAiGuide.en.title, url: `${SITE_ORIGIN}/en/blog/web-design-with-ai` }], `${SITE_ORIGIN}/en/blog/web-design-with-ai`),
    ],
  },
  ...
  // seo2 manual blog automation: /en/blog/ai-for-work EN sibling.
  {
    path: "/en/blog/ai-for-work",
    htmlLang: "en",
    hreflangAlternates: {
      ru: `${SITE_ORIGIN}/blog/ai-for-work`,
      en: `${SITE_ORIGIN}/en/blog/ai-for-work`,
    ...
    title: aiForWorkGuide.en.title,
    description: aiForWorkGuide.en.description,
    canonical: `${SITE_ORIGIN}/en/blog/ai-for-work`,
    ogTitle: aiForWorkGuide.en.title,
    ogDescription: aiForWorkGuide.en.excerpt,
    ogImage: `${SITE_ORIGIN}${aiForWorkGuide.en.cover.src}`,
    author: FOUNDER_NAME,
    prerender: "full",
    changefreq: "monthly",
    priority: 0.7,
    schema: [
      ORG_BLOCK_EN,
      blogPostingBlock({
        pageId: `${SITE_ORIGIN}/en/blog/ai-for-work`,
        headline: aiForWorkGuide.en.title,
        description: aiForWorkGuide.en.description,
        datePublished: aiForWorkGuide.en.publishedAt,
        dateModified: aiForWorkGuide.en.updatedAt,
        inLanguage: "en-US",
        articleSection: "Guide",
        keywords: aiForWorkGuide.en.tags,
        image: {
          url: `${SITE_ORIGIN}${aiForWorkGuide.en.cover.src}`,
          width: aiForWorkGuide.en.cover.width,
          height: aiForWorkGuide.en.cover.height,
        },
      }),
      webPageBlock({
        pageId: `${SITE_ORIGIN}/en/blog/ai-for-work`,
        url: `${SITE_ORIGIN}/en/blog/ai-for-work`,
        name: aiForWorkGuide.en.title,
        inLanguage: "en-US",
        cssSelector: ["h1", ".blog-intro", "h2"],
      }),
      howToBlock(
        (aiForWorkGuide.en.body.steps ?? []).map((s) => ({ title: s.title, body: s.body })),
        `${SITE_ORIGIN}/en/blog/ai-for-work`,
        aiForWorkGuide.en.title,
      ),
      faqPageBlock(aiForWorkGuide.en.body.faq ?? [], `${SITE_ORIGIN}/en/blog/ai-for-work`),
      breadcrumbBlock(
        [
          { name: "Home", url: `${SITE_ORIGIN}/en/` },
          { name: "Blog", url: `${SITE_ORIGIN}/en/blog` },
          { name: aiForWorkGuide.en.title, url: `${SITE_ORIGIN}/en/blog/ai-for-work` },
        ],
        `${SITE_ORIGIN}/en/blog/ai-for-work`,
      ),
    ],
  ...
  // seo2 manual blog automation: /en/blog/ai-courses-for-beginners EN sibling.
  {
    path: "/en/blog/ai-courses-for-beginners",
    htmlLang: "en",
    hreflangAlternates: {
      ru: `${SITE_ORIGIN}/blog/ai-courses-for-beginners`,
      en: `${SITE_ORIGIN}/en/blog/ai-courses-for-beginners`,
    ...
    title: aiCoursesForBeginnersGuide.en.title,
    description: aiCoursesForBeginnersGuide.en.description,
    canonical: `${SITE_ORIGIN}/en/blog/ai-courses-for-beginners`,
    ogTitle: aiCoursesForBeginnersGuide.en.title,
    ogDescription: aiCoursesForBeginnersGuide.en.excerpt,
    ogImage: `${SITE_ORIGIN}${aiCoursesForBeginnersGuide.en.cover.src}`,
    author: FOUNDER_NAME,
    prerender: "full",
    changefreq: "monthly",
    priority: 0.7,
    schema: [
      ORG_BLOCK_EN,
      blogPostingBlock({
        pageId: `${SITE_ORIGIN}/en/blog/ai-courses-for-beginners`,
        headline: aiCoursesForBeginnersGuide.en.title,
        description: aiCoursesForBeginnersGuide.en.description,
        datePublished: aiCoursesForBeginnersGuide.en.publishedAt,
        dateModified: aiCoursesForBeginnersGuide.en.updatedAt,
        inLanguage: "en-US",
        articleSection: "Guide",
        keywords: aiCoursesForBeginnersGuide.en.tags,
        image: {
          url: `${SITE_ORIGIN}${aiCoursesForBeginnersGuide.en.cover.src}`,
          width: aiCoursesForBeginnersGuide.en.cover.width,
          height: aiCoursesForBeginnersGuide.en.cover.height,
        },
      }),
      webPageBlock({
        pageId: `${SITE_ORIGIN}/en/blog/ai-courses-for-beginners`,
        url: `${SITE_ORIGIN}/en/blog/ai-courses-for-beginners`,
        name: aiCoursesForBeginnersGuide.en.title,
        inLanguage: "en-US",
        cssSelector: ["h1", ".blog-intro", "h2"],
      }),
      howToBlock(
        (aiCoursesForBeginnersGuide.en.body.steps ?? []).map((s) => ({ title: s.title, body: s.body })),
        `${SITE_ORIGIN}/en/blog/ai-courses-for-beginners`,
        aiCoursesForBeginnersGuide.en.title,
      ),
      faqPageBlock(aiCoursesForBeginnersGuide.en.body.faq ?? [], `${SITE_ORIGIN}/en/blog/ai-courses-for-beginners`),
      breadcrumbBlock(
        [
          { name: "Home", url: `${SITE_ORIGIN}/en/` },
          { name: "Blog", url: `${SITE_ORIGIN}/en/blog` },
          { name: aiCoursesForBeginnersGuide.en.title, url: `${SITE_ORIGIN}/en/blog/ai-courses-for-beginners` },
        ],
        `${SITE_ORIGIN}/en/blog/ai-courses-for-beginners`,
      ),
    ],
