// Phase 4 D-04 / D-05: anchor guide. Additional guides land in Phase 4.1 — append to guidesBySlug barrel.
// Bilingual content payload (RU + EN). Both bodies are HUMAN-CURATED — sourced from the author's
// promptscore-proxy/skills/gpt-image-2.md (which itself digests OpenAI Cookbook + fal.ai docs) and
// approved verbatim by user 2026-05-17 per D-07 (no LLM-generated body on E-E-A-T pages).
