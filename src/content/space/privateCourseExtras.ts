  ...
  "lesson-2-ai-services": {
    materials: {
      ru: [
        ...
        pending("Тарифы Syntx", "Проверить актуальность VIP/других тарифов перед публикацией", "Проверить"),
      ],
    },
    missingItems: {
      ru: [
        missing("Точные названия разделов Syntx", "Забрать с экрана, чтобы не ошибиться в тексте урока."),
        missing("Тарифы и кредиты", "Проверить тарифы, лимиты и формулировки на дату публикации."),
        missing("Скриншот замочка у поля prompt", "Нужен скрин или точный таймкод из видео."),
      ],
    },
  },
