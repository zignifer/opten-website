...
const privateCourseLessonConfigs: PrivateCourseLessonConfig[] = [
  ...
  },
  {
    ...
    description: {
      ru: "В уроке показываю, как разобрать чужой видео-референс и превратить его в понятное ТЗ для генерации. На примере первого кадра и Seedance проверяю, насколько близко получается повторить механику ролика.",
      en: "This lesson shows how to analyze a video reference and turn it into a clear generation brief. A first frame and Seedance are used to test how closely the motion can be repeated.",
    },
    category: "vibe-coding",
    duration: "04:33",
    durationIso: "PT4M33S",
