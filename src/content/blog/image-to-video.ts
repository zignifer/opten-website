...
const ru: BlogPostLocale = {
  ...
  excerpt:
    "Как оживить фото через нейросеть: структура промпта, движение камеры, темп сцены и финальная проверка для Kling 3.0, Veo 3.1 и Seedance 2.0.",
  description:
    "Гайд по image-to-video: как оживить фото через нейросеть, описать сцену, камеру и preserve-блоки для стабильного видео в Kling 3.0, Veo 3.1 и Seedance 2.0.",
  category: "guide",
...
const en: BlogPostLocale = {
  ...
  excerpt:
    "A practical image-to-video workflow for Kling 3.0, Veo 3.1, and Seedance 2.0: source frame, camera motion, scene pace, constraints, and final QA.",
  description:
    "Learn an image to video AI workflow for Kling 3.0, Veo 3.1, and Seedance 2.0: source frame, camera motion, scene pace, constraints, and final QA.",
  category: "guide",
  tags: ["ai-video-gen", "workflow", "prompt-engineering"],
  cover: COVER_EN,
  readingTimeMin: 6,
