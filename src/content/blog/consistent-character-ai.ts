...
const ru: BlogPostLocale = {
  ...
  title: "Одинаковый персонаж через нейросеть: workflow",
  excerpt:
    "Как создать одинакового персонажа через нейросеть: референс-лист, identity-блок, preserve-ограничения и проверка серии в GPT Image 2, Nano Banana Pro и Kling 3.0.",
  description:
    "Практический workflow: как создать одинакового персонажа через нейросеть, удержать лицо, одежду и руки в GPT Image 2, Nano Banana Pro и Kling 3.0 без drift.",
  category: "guide",
  ...
  body: {
    ...
    faq: [
      {
        q: "Как создать одинакового персонажа через нейросеть?",
