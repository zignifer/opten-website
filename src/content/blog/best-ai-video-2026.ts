  ...
  body: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Видео стоит дороже изображения, поэтому плохой prompt быстро сжигает бюджет. Модель должна знать сцену, действие, камеру, звук и ограничения. Без этого даже сильный генератор AI-видео додумывает детали и ломает физику, лицо или ритм.",
      },
      {
        q: "Как сравнить генераторы AI-видео перед подпиской?",
