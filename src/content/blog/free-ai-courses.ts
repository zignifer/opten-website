...
const COURSE_BANNER_RU = {
  ...
  width: 1600,
  height: 560,
  alt: "Курс по ИИ-контенту: путь от промпта к готовому проекту",
};
...
const ru: BlogPostLocale = {
  ...
  excerpt:
    "Бесплатное обучение нейросетям и бесплатные курсы по ИИ дают старт, если каждый урок заканчивается задачей, промптом и небольшим готовым результатом.",
  description:
    "Бесплатное обучение нейросетям помогает освоить первые задачи для ИИ: выбрать практику, написать промпт, исправить ошибку и собрать мини-кейс без платного курса.",
  category: "guide",
  ...
  body: {
    ...
    steps: [
      ...
      },
      {
        ...
        body:
          "Тем, кто изучает нейросети с нуля, полезнее собрать короткую неделю практики, чем искать идеальную программу. В первый день сделайте текстовый черновик, во второй - визуальное задание, в третий - один слайд, в четвертый - короткий ролик или раскадровку, а в пятый соедините материалы в одну понятную историю. Пять маленьких артефактов дают больше понимания, чем пять часов обзоров.\n\nНе пытайтесь пройти все бесплатные курсы по нейросетям подряд. Сохраняйте исходную задачу, первый промпт, первую ошибку и версию после правки. Так постепенно появляется свой набор рабочих приемов. Когда задача уже выбрана, Opten может подсветить, чего в промпте не хватает: цели, контекста, формата, ограничений или критерия проверки. Это полезнее, чем угадывать, почему модель снова выдала общий ответ.",
        before:
          "На этой неделе посмотрю уроки про ChatGPT, картинки, видео и презентации, а практику начну, когда разберусь во всем.",
        after:
          "На этой неделе соберу один мини-кейс: текст, визуальное задание, один слайд и короткую раскадровку для одной задачи. После каждого этапа сохраню промпт и правку.",
        imageSrc: "/blog/free-ai-courses/ru/step-2.jpg",
      },
      {
        title: "Превратите просмотр урока в короткий промпт",
        body:
          "Пассивное обучение начинается с фразы «сначала посмотрю еще пару видео». Практика начинается с вопроса, что вы хотите получить к концу занятия. Перед запуском модели назовите цель, добавьте контекст, задайте формат и решите, по какому признаку оцените результат. Такой промпт не обязан быть длинным, но он не оставляет модели гадать, что считать удачным ответом.\n\nЭто особенно заметно на простых заданиях. Если после урока про презентации написать «сделай слайды», вы получите общую заготовку. Если обозначить аудиторию, количество слайдов, исходные факты и один критерий качества, появится материал для проверки. Затем можно исправить только слабый элемент: сократить вступление, уточнить визуальный образ или попросить другой тон. Так формируется привычка не потреблять уроки, а ставить задачи.",
      ...
      },
      {
        ...
        body:
          "Первый кейс не обязан быть коммерческим. Достаточно показать путь: какая была задача, какой промпт вы написали, что в первой версии не сработало, как вы это поправили и что вышло в финале. Такая папка честнее сертификата: по ней видно, умеете ли вы доводить задачу для ИИ до результата и объяснять свои решения.\n\nБесплатного обучения достаточно, чтобы попробовать направление и собрать базовую практику. Платный курс имеет смысл позже, когда вы понимаете, что хотите повторять один сценарий, но вам не хватает последовательной программы, обратной связи или более сложного проекта. Тогда вы платите не за доступ к названиям инструментов, а за темп, разбор ошибок и среду, где работу нужно закончить.",
        before:
          "У меня есть список уроков и сохраненные ссылки, но я не могу показать, чему научился.",
        after:
          "Мой мини-кейс: задача, промпт, первая версия, одна правка, финальный артефакт и короткий вывод о том, что сделаю иначе в следующий раз.",
        imageSrc: "/blog/free-ai-courses/ru/step-4.jpg",
        promoBanner: {
          eyebrow: "Курс Opten",
          title: "Соберите практику с ИИ вокруг одного проекта",
          body:
            "Курс помогает пройти полный цикл: промпт, изображения, видео, сайт и рекламные материалы для одного проекта, чтобы практика сразу стала портфолио-кейсом.",
    ...
    faq: [
      {
        ...
        a: "Да. Начните с бесплатных уроков по одному прикладному сценарию: текст, визуал, презентация или видео. После каждого урока делайте небольшую работу и сохраняйте промпт с результатом, иначе обучение останется просмотром.",
      },
      {
        q: "Можно ли освоить нейросети с нуля бесплатно?",
        a: "Можно освоить базовую логику: как поставить задачу, дать модели контекст, выбрать формат и проверить ответ. Бесплатный формат подходит для первых рабочих процессов и мини-кейсов, но требует собственного ритма и дисциплины.",
      },
      {
      ...
      },
      {
        ...
        a: "Достаточно одной небольшой задачи на 30-40 минут. Важно завершить ее: сохранить промпт, отметить первую ошибку, сделать одну правку и положить финальный результат в папку с кейсами.",
      },
    ],
  },
};
