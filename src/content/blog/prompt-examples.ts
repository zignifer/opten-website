...
const ru: BlogPostLocale = {
  ...
  excerpt:
    "Примеры промптов работают лучше, когда вы видите структуру, модельные допущения и слабые места, а не копируете шаблон вслепую.",
  description:
  ...
  body: {
    ...
    steps: [
      ...
      {
        title: "Читайте примеры промптов по блокам",
        body:
    ...
    faq: [
      ...
      {
        q: "Как использовать примеры промптов без копирования?",
