...
const ru: BlogPostLocale = {
  ...
  excerpt:
    "Kling 3.0 и клинг 3 требуют не красивых тегов, а режиссерского prompt: сцена, камера, движение, continuity и ограничения.",
  description:
    "Kling 3.0 это AI-видео модель для управляемых сцен. Разбираем клинг 3.0, Omni, motion prompt, цену и типичные ошибки.",
  category: "guide",
  ...
  body: {
    intro:
      "Kling 3.0 это линейка AI video моделей Kuaishou для более длинных, связных и управляемых сцен: Video 3.0, Video 3.0 Omni, Image 3.0 и Image 3.0 Omni. В клинг 3.0 промпт должен описывать не только идею, но и камеру, движение, continuity, звук и запреты.",
    steps: [
      {
        title: "Пишите сцену как режиссерский бриф",
        body:
          "Главная ошибка в клинг 3 промпт — начинать с имени модели и набора эстетических слов. `Kling 3.0, cinematic, realistic, dramatic` не объясняет, что происходит в кадре, где стоит камера и какой объект нельзя менять. Модель получает настроение, но не получает постановку.\n\nРабочий порядок проще: `Scene` -> `Subject` -> `Action` -> `Camera` -> `Motion` -> `Lighting` -> `Audio` -> `Constraints`. Даже если вы думаете по-русски, финальный production prompt лучше собрать на английском: camera path, subject lock и motion constraints обычно читаются стабильнее. Opten здесь полезен как preflight: он разворачивает короткую идею в блоки и подсвечивает, где забыта камера или запрет.",
        before:
    ...
    faq: [
      ...
      {
        q: "Чем клинг 3 отличается от старых video-моделей?",
      ...
      {
        q: "Как писать kling 3 промпт для стабильного персонажа?",
