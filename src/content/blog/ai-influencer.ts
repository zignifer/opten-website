...
const ru: BlogPostLocale = {
  slug: "ai-influencer",
  title: "AI influencer: как создать ИИ-инфлюенсера с одним лицом",
  excerpt:
    "AI influencer и ai influencer higgsfield работают стабильнее, когда у персонажа есть character bible: лицо, стиль, сцены и prompt lock.",
  description:
    "AI influencer guide: как создать ИИ-инфлюенсера для Instagram, собрать character bible, стабилизировать сцены и промпты.",
  category: "guide",
  ...
  body: {
    ...
    steps: [
      ...
      },
      {
        ...
        body:
          "Когда нужно ИИ инфлюенсер создать для контента, модель должна понимать не только внешность, но и набор повторяемых ситуаций. «Сделай lifestyle контент» слишком широко: сегодня получится кафе, завтра пляж, послезавтра глянцевая реклама. Лучше задать scene grid: 4-6 типов кадров, которые можно повторять без потери identity.\n\nПример сетки: street portrait, product-in-hand, mirror prep, night cafe, backstage fitting, vertical video hook. В каждом типе повторяются лицо, волосы, один-два предмета одежды и свет. Так ИИ инфлюенсер Инстаграм выглядит как серия одного автора, а не как набор разных моделей из стока.",
        before:
      ...
      },
      {
        ...
        before:
          "Сделай reels про нового AI influencer, модно, реалистично, красиво.",
        after:
    ...
    faq: [
      ...
      {
        q: "Как создать AI influencer без постоянной смены лица?",
      ...
      {
        q: "Что важно в ai influencer higgsfield workflow?",
      ...
      {
        q: "Можно ли сделать ИИ инфлюенсер Инстаграм за один вечер?",
