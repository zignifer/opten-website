...
const ru: BlogPostLocale = {
  ...
  title: "Бизнес портрет нейросеть: деловое фото без стока",
  excerpt:
    "Бизнес портрет нейросеть делает убедительнее, когда prompt фиксирует фон, свет, объектив, одежду и естественную кожу вместо общего запроса.",
  description:
    "Бизнес портрет нейросеть: как написать prompt для делового портрета, выбрать фон, свет, объектив и проверить нейросеть для делового фото.",
  category: "guide",
  ...
  body: {
    intro:
      "Запрос «бизнес портрет нейросеть» обычно означает не красивое селфи, а деловое фото для сайта, LinkedIn, презентации или карточки эксперта. Нейросеть справляется лучше, когда prompt задает фон, свет, объектив, одежду и естественную фактуру кожи, а не просит «профессиональный портрет» одним абзацем.",
    steps: [
      {
      ...
      {
        title: "Деловой портрет нейросеть держит на фоне, свете и объективе",
        body:
    ...
    faq: [
      {
        q: "Можно ли сделать бизнес портрет нейросетью?",
      ...
      {
        q: "Почему деловой портрет нейросеть делает похожим на сток?",
