...
const COVER_RU = {
  ...
  width: 1600,
  height: 900,
  alt: "Обложка гайда про апскейл фото через нейросеть и сохранение деталей",
};
const COVER_EN = {
  src: "/blog/upscale-image-ai/cover.jpg",
  width: 1600,
...
const ru: BlogPostLocale = {
  ...
  title: "Апскейл фото через нейросеть: как улучшить картинку",
  excerpt:
    "Апскейл фото через нейросеть увеличивает размер, но работает чище, если исходник уже держит свет, материал, фокус и ограничения.",
  description:
    "Когда стоит делать онлайн-апскейл через нейросеть, а когда лучше переписать prompt, чтобы сохранить детали, резкость и материал.",
  category: "guide",
  ...
  body: {
    ...
    faq: [
      {
        q: "Что такое апскейл фото через нейросеть?",
        a: "Апскейл фото через нейросеть — это увеличение изображения с попыткой сохранить или усилить детали. Модель повышает разрешение, резкость и микроконтраст, но не гарантирует восстановление того, чего не было в исходнике.",
      },
      {
        q: "Когда стоит использовать онлайн-апскейл изображения через нейросеть?",
        a: "Используйте онлайн-апскейл через нейросеть, когда композиция, объект и материал уже хорошие, но нужен больший размер для сайта, презентации или печати. Если исходник неверный по смыслу, лучше сначала переписать prompt.",
      },
      {
        q: "Можно ли улучшить качество картинки через нейросеть без нового prompt?",
      ...
      {
        q: "Как получить высокую детализацию при апскейле фото?",
