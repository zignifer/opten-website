...
const ru: BlogPostLocale = {
  ...
  description: "Нейросети для презентаций: как задать цель, собрать структуру, написать промпт и проверить дизайн. Практический процесс для сильных ИИ-презентаций.",
  category: "guide",
  ...
  body: {
    intro: "Нейросети для презентаций могут собрать логику слайдов, сократить текст и предложить визуальное направление. Но полезный результат начинается не с кнопки «Создать», а с ясного технического задания: зачем нужна презентация, кто ее увидит, какое решение должен принять зритель и какими фактами вы это решение поддержите.",
    steps: [
      {
      ...
      {
        title: "Промпт для слайдов: контекст, данные, тон и формат",
        body: "Хороший промпт похож на техническое задание для дизайнера. Дайте контекст встречи, аудиторию и уровень ее знаний. Затем перечислите исходные данные, желаемый тон и формат ответа. Визуальное направление описывайте через функцию: например, «спокойный аналитический стиль, диаграммы вместо декоративных иллюстраций, один акцентный цвет». Это полезнее, чем набор слов «современно, дорого, вау».\n\nПрактический кейс: Марина собирала в Gamma презентацию сервиса для бизнеса. Первый запрос «сделай презентацию о продукте» дал шаблонные обещания и 14 перегруженных слайдов. Она исправила промпт: назвала аудиторию, цель встречи, 8 слайдов, три подтвержденных показателя, спокойный тон и запрет на неподтвержденные цифры. Gamma вернула связный каркас; Марина вручную проверила факты и сократила два слайда. Opten здесь полезен для проверки перед генерацией: помогает заметить недостающий контекст.",
        before: "Сделай стильную продающую презентацию.",
        after: "Контекст: первая встреча с корпоративным клиентом. Аудитория: директор по маркетингу. Цель: согласовать пилот. Данные: используй только три показателя ниже. Тон: уверенный, без рекламных штампов. Формат: 8 слайдов, один вывод и до 3 тезисов на каждом. Визуал: аналитический, диаграммы для чисел, один акцентный цвет.",
        imageSrc: "/blog/ai-presentations/ru/step-3.jpg",
      },
      {
        title: "Проверьте текст, факты и единый стиль",
        body: "Даже сильный ИИ для презентаций не знает, какие цифры в компании актуальны и что можно показывать внешней аудитории. Сверьте каждое число с источником, уберите общие фразы вроде «революционное решение» и проверьте, отвечает ли заголовок слайда на вопрос «что зритель должен понять». Затем оцените всю презентацию в режиме миниатюр: заметны ли повторы, скачки плотности и случайные стили.\n\nПоследняя проверка проходит вслух. Проговорите переход между слайдами и засеките время. Если объяснение держится только на длинном комментарии, слайду не хватает ясного вывода. Если на экране лежит весь текст выступления, его нужно сократить. Фрилансер может продавать такой процесс как услугу: техническое задание, структура, редактура, визуальное направление и финальная проверка, а не обещание «идеальной презентации одной кнопкой».",
        before: "Публикую презентацию, если она выглядит аккуратно и модель не показывает ошибок.",
        ...
        promoBanner: { eyebrow: "Курс Opten", title: "Соберите презентацию как часть реального ИИ-проекта", body: "На курсе вы проходите путь от технического задания и промпта до визуалов, сайта и рекламных материалов с понятной логикой проверки.", ctaLabel: "Смотреть курс", href: COURSE_URL, image: { src: "/blog/_banners/course-workflow.jpg", width: 1600, height: 560, alt: "Курс по ИИ-контенту: процесс от промпта до готового проекта" } },
      },
    ],
    faq: [
      { q: "Какая нейросеть делает презентации?", a: "Gamma, Canva и другие инструменты с ИИ умеют собирать черновик презентации, но выбор зависит от нужного экспорта, совместной работы и контроля дизайна. Сначала проверьте сервис на одном реальном техническом задании, а не по демонстрационному шаблону." },
      ...
      { q: "Как написать промпт для презентации?", a: "Укажите цель встречи, аудиторию, действие после просмотра, исходные факты, число слайдов, тон и формат каждого слайда. Отдельно запретите выдумывать данные и попросите отмечать места, где нужен источник." },
      { q: "Нужно ли проверять презентацию после генерации?", a: "Обязательно. Проверьте факты, конфиденциальность, логику переходов, повторы, читаемость и единый стиль. Сгенерированная презентация остается черновиком, пока специалист не подтвердил каждое утверждение." },
    ],
  },
};
