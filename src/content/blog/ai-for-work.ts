...
const ru: BlogPostLocale = {
  ...
  description:
    "Нейросети для работы ускоряют презентации, тексты, письма, видео и анализ: 10 рабочих задач, структура промпта и проверка результата человеком перед отправкой.",
  category: "guide",
  ...
  body: {
    intro:
      "Нейросети для работы помогают быстрее собрать первый черновик, структуру или визуальное направление для конкретной задачи. Уже сегодня можно ускорить презентацию, текст, письмо, видео, исследование или техническое задание. Но ИИ не принимает решение за специалиста: человек проверяет факты, смысл, тон и то, подходит ли результат клиенту или команде.",
    steps: [
      {
        title: "Нейросети для работы: 10 задач, с которых удобно начать",
        body:
          "Не начинайте с вопроса, какая нейросеть лучше всех. Выберите задачу, которая уже лежит в вашей работе. ИИ для работы может помочь с планом презентации, первым текстовым черновиком, письмом клиенту, раскадровкой видео, визуальным заданием, карточкой товара, структурой сайта, исследовательскими вопросами, контент-планом и техническим заданием для подрядчика. Во всех десяти случаях модель ускоряет подготовку, а не отменяет профессиональную проверку.\n\nДля первого опыта берите задачу с ясным владельцем и коротким сроком. Например, не «сделать маркетинг», а «подготовить структуру семи слайдов к встрече в четверг». Так проще увидеть, где результат помогает, а где ему не хватает фактов, данных или знания контекста. Нейросети для презентаций, текста и видео дают разный формат черновика, но рабочий принцип один: сначала задача, затем понятный промпт, потом проверка.",
      ...
      {
        title: "Как писать промпт под рабочую задачу",
        body:
          "Рабочий промпт обычно выигрывает не длиной, а четырьмя опорами: целью, аудиторией, форматом и критерием качества. Цель объясняет, зачем нужен материал. Аудитория задает уровень деталей и тон. Формат ограничивает ответ: письмо, таблица, сценарий, структура слайдов или визуальное задание. Критерий помогает понять, что проверить до отправки.\n\nДля текстовой задачи это может быть письмо с двумя вариантами темы. Для видео - раскадровка с длительностью и действием в кадре. Для сайта - список блоков, аудитория и один путь пользователя. Когда промпт еще сырой, Opten помогает заметить недостающий контекст или ограничение до того, как вы потратите время на несколько случайных вариантов. После первого ответа меняйте один слабый слой, а не переписывайте задачу с нуля.",
      ...
      },
      {
        ...
        promoBanner: {
          eyebrow: "Курс Opten",
          title: "Соберите процесс работы с ИИ вокруг реального проекта",
          body:
            "Курс соединяет промпт, изображения, видео, сайт и рекламные материалы в один проект, чтобы практика давала не набор черновиков, а законченный кейс.",
    ...
    faq: [
      {
        ...
        a: "Подходят те модели, которые решают конкретный тип задачи: текст, презентация, визуальное задание, видео, исследование или структура сайта. Выбирайте не по громкому названию, а по тому, какой черновик вам нужно получить и как вы его будете проверять.",
      },
      {
        q: "Как начать работать с нейросетями?",
        a: "Возьмите одну реальную задачу с коротким сроком, опишите цель, аудиторию, формат и критерий качества. Сохраните первый промпт и сделайте одну правку после результата. Такой цикл быстрее учит, чем просмотр обзоров сервисов.",
      },
      {
      ...
      },
      {
        ...
        a: "Да, если начать с небольшой задачи и не ожидать готового ответа без проверки. Обучение ИИ становится практичным, когда вы повторяете один процесс: техническое задание, промпт, черновик, проверка и правка.",
      },
    ],
  },
};
