...
const ru: BlogPostLocale = {
  slug: "ai-face-swap",
  title: "Замена лица в нейросети: аккуратный face swap без артефактов",
  excerpt:
  ...
  description:
    "Как подобрать исходники, описать свет, кожу и мимику, чтобы замена лица в нейросети не дала заметные артефакты на фото.",
  category: "guide",
  ...
  body: {
    ...
    faq: [
      {
        q: "Как работает замена лица в нейросети?",
