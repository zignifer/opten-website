    ...
    <header className={`fixed left-0 right-0 ${ANNOUNCEMENT_ENABLED ? "top-[40px]" : "top-0"} z-50 border-b border-white/10 bg-[#011417]/95 backdrop-blur-sm`}>
      ...
      >
        <LocalizedLink
          ...
          className="-ml-[4px] inline-flex h-[32px] w-[132px] items-center rounded-sm px-[4px] no-underline outline-none focus-visible:ring-2 focus-visible:ring-[#9cfb51] focus-visible:ring-offset-2 focus-visible:ring-offset-[#011417]"
        >
          <img
        ...
        <div className="flex items-center justify-center gap-[8px] max-lg:hidden" aria-label="Opten navigation">
          ...
          <CurrencySwitcher className="flex h-[32px] min-w-[48px] cursor-pointer items-center justify-center rounded-full border border-white/10 bg-transparent px-[10px] font-['PT_Root_UI',sans-serif] text-[13px] font-bold text-white/70 transition hover:border-white/25 hover:text-white" />
