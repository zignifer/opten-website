...
const copy = {
  ru: {
    ...
    proLimit: "Кредиты закончились. Перейдите на PRO",
    ...
    vibecodingModeSuggested: "Похоже, это запрос для кодинг-агента. Режим переключён на «Вайб-кодинг / Codex». Проверьте выбор и нажмите «Улучшить» ещё раз — кредит не списан.",
  },
  en: {
