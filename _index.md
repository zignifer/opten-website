...
- `REQUIREMENTS.md` — falsifiable requirements; created fresh per milestone (archived to `milestones/v<X>-REQUIREMENTS.md` on close, so absent between milestones)
...
62 model pages × RU/EN + 2 hubs = 144 prerendered routes. 62 content files generated by 7 parallel agents, verified 62/62, IndexNow pinged. Post-Phase-2 hotfixes: EN meta + head-meta localization, hub redesign to blog parity, blog/models hydration fix, seedance dedupe, 11 umbrella cards hidden (kept live). Archive at [[.planning/milestones/v2.0-ROADMAP|v2.0-ROADMAP]] + [[.planning/milestones/v2.0-REQUIREMENTS|v2.0-REQUIREMENTS]]. **Carried forward:** MODELS-B-6 — ≥60% URL Indexed in GSC, monitoring window ~2026-05-27..06-03.

### v1.0 (GEO Optimization) — CLOSED 2026-05-17

GEO score 12/100 → ~72.6 (target ~80+ after deploy bakes in). 7 phases shipped end-to-end; archive at [[.planning/milestones/v1.0-ROADMAP|v1.0-ROADMAP]] + [[.planning/milestones/v1.0-REQUIREMENTS|v1.0-REQUIREMENTS]]. A post-v1.0 hotfix series (2026-05-17..18) added the blog surface, retired `/guides/*`, unified `<SiteHeader>`/`<SiteFooter>` — tracked inline in [[.planning/STATE|STATE]].

### Next milestone (v2.1+) — TBD

No active milestone. Run `/gsd-new-milestone` to start the next one from the candidates in [[.planning/ROADMAP|ROADMAP]] (v2.1 cover images for top-15 + `/compare/*`, v2.2 SEO polish, v3.0 brand authority).
